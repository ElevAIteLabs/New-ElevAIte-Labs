        ...
        <div className="footer-grid">
          <div>
            <Link to="/" className="logo">
              <img src="/pictures/logo-mark.png" alt="ElevAIte Labs" style={{ height: '88px', width: 'auto', display: 'block', marginLeft: '-6px' }} />
            </Link>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link to="/services">Web & Mobile App Development</Link></li>
              <li><Link to="/services">Custom AI Agents</Link></li>
              <li><Link to="/services">Lead Generation Systems</Link></li>
              <li><Link to="/services">AI Content Creation</Link></li>
          ...
          <div className="footer-col">
            <h4>Products</h4>
            <ul>
              <li><Link to="/products">Kredoo</Link></li>
